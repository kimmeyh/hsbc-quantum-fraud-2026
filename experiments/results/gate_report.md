...
Rows: 158 (120 [SIM], 38 [HW]). Every number below traces to results.json; each cell carries the evidence tag of the rows it summarizes (cvqboost_hw and cvqboost_hw_mixed cells are [HW], all others [SIM]).
...
| cvqboost_hw/hw_b2_full/stratified/full | 1 | 0.8231 | n/a | n/a | 0.9547 | 0.00167 |
...
| cvqboost_hw/hw_b2_full/stratified/full | 1 | 0 | 0.864 | 4269 |
...
38 successful fits, 0 failed, metered seconds recorded: 254.0 (None-valued rows: 0)
By arm: cvqboost_hw 28 fits 211.0 s; cvqboost_hw_mixed 10 fits 43.0 s.
...
| hw_b2_full/stratified | 1 | 0.8231 | 0.7551 | 0.8282 | +187.1 |
