...
Rows: 147 (120 [SIM], 27 [HW]). Every number below traces to results.json; each cell carries the evidence tag of the rows it summarizes (cvqboost_hw cells are [HW], all others [SIM]).
