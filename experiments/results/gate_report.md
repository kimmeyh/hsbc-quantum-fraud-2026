...
Rows: 168 (120 [SIM], 48 [HW]). Every number below traces to results.json; each cell carries the evidence tag of the rows it summarizes (cvqboost_hw and cvqboost_hw_mixed cells are [HW], all others [SIM]).
