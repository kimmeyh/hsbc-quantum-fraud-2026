...
Rows: 188 (140 [SIM], 48 [HW]). Every number below traces to results.json; each cell carries the evidence tag of the rows it summarizes (cvqboost_hw and cvqboost_hw_mixed cells are [HW], all others [SIM]).
...
| cvqboost_proxy/deep/dct/full | 10 | 0.7926 | 0.0295 | [0.7715, 0.8137] | 0.9355 | 0.00167 |
...
Proxy cell used: cvqboost_proxy/deep/dct/full
Best matched GBDT: catboost. Delta = proxy_CVQBoost - catboost, 10 seeds.
Mean delta -0.0144, seed SD 0.0273, 95% CI [-0.0339, +0.0051].
MDE(10 seeds) recomputed from this SD: 0.0271 (adjudication uses the amendment-A5 value 0.0268; any change is Class-1).
...
| cvqboost_proxy/deep/dct/full | 10 | 10 | 0.915 | 215 |
