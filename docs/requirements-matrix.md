...
| A5b | Team Profile delivery: no portal form found, so the profile (team name, lead contact, member description, prior experience, Claude Code disclosure) ships as a one-page PDF in its own upload slot | Guidelines s4.1 + portal walkthrough | TODO | Slot budget: 1 proposal PDF (6pp) + 1 appendix PDF (3pp, or combined with proposal) + 1 team-profile PDF still leaves 2 spare slots of the 5 |
