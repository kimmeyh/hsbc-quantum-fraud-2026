...
| [0014](0014-fact-database.md) | Fact database: SQLite plus committed export, three record classes, reading level escalates 8 to 20, starts outside this repository | Proposed | 2026-09-12 |
