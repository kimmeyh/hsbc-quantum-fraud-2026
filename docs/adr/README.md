...
| [0014](0014-fact-database.md) | Evidence Based DB: SQLite plus committed export, three record classes, reading level escalates 8 to 20; private repo `EvidenceBasedDB` | **Accepted**, then MOVED. Live copy is EvidenceBasedDB ADR-0004; this copy is frozen. Amend it there | 2026-09-13 |
| [0015](0015-reference-library.md) | Reference-paper library: papers are SOURCES OF ASSERTIONS; records not PDFs; GRADE-derived certainty; search before embeddings | **Accepted**, then MOVED. Live copy is EvidenceBasedDB ADR-0005; this copy is frozen. Amend it there | 2026-09-14 |
