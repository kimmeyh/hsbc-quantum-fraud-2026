...
| [0014](0014-fact-database.md) | Evidence Based DB: SQLite plus committed export, three record classes, reading level escalates 8 to 20; private repo `EvidenceBasedDB` | **Accepted** | 2026-09-13 |
