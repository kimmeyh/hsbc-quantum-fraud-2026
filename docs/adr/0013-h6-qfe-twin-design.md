...
Fourier Wall", arXiv:2607.15815, section 6.4); prior in-segment CVQBoost tuning results held privately by the team lead (not
distributed with the submission and not relied on for any claim here)
