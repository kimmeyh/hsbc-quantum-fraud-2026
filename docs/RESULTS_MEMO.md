...
|---|---|---|---|---|
| G0 | Tuned-XGB full-feature mean test AUPRC >= 0.85 (10 seeds) | **FAIL as committed**: 0.8296, CI [0.8092, 0.8501]. Footnote: the 0.85 threshold derived from a literature band that primary-source research (F21) could not corroborate; A7 sensitivity cells (S1 metric, S2 duplicates, S3 split ratio) APPROVED 2026-09-03 and will quantify the protocol differences | [SIM] | none (criterion unchanged); **A7 approved** |
...
## Headline framing -- DECIDED 2026-09-03 by the team lead (Class-2 decision of record)
...
**DECISION (team lead, 2026-09-03)**: option 2's system framing as the spine, with option 1's regime map as the method inside it. The proposal's posture is a program headed for a production trial, not a benchmark report:
