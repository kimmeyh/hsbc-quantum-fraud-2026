...
**F78. Convert every PowerShell script to Python so the repository is OS agnostic (~6-9h) Priority 8**
- Phase: Finalize / tooling (team lead, 2026-09-15)
- Platform: `.claude/hooks` (9 files), `scripts/` (4 files). `.venv/Scripts/activate.ps1` is generated and OUT of scope
