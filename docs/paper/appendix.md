...
**B.2 Amendments.** Thirty-one dated amendments, A1 to A31, each with rationale and approval, in the repository. Cited here: A11 to A18 register exploratory arms; A12 the free-tier 100-variable ceiling; A17 every A11/A13 figure recomputed after three fold builders skipped deduplication, moving the tuned-pool result from below to above the MDE; A20 memorisation, not majority-class collapse; A21 the ceiling was a billing tier; A22/A23 the hardware ladder published, withdrawn, re-run; A26 the comparator certified by KKT residual; A27 two mechanism claims withdrawn; A28 two protocol deviations including the G0 halt; A31 frozen-pool agreement forced by resolution. No amendment changed a gate criterion; no gate was rescored after observation.
